...
- **Open threads:** `OPEN_THREADS.md` (active, brewing, dormant, ready-for-payoff, retired, open canon)
- **Decision log:** `Decision Log.md` (canon decisions, D-001+)
- **Note:** `Storylines & Fronts/` directory exists but is currently empty — fronts are tracked in `OPEN_THREADS.md` instead
