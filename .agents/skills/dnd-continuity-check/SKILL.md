...
2. `Decision Log.md` — LOCKED entries (see Decision Log filter in dnd-session-prep Step 1 Tier 2). This is the authoritative source for settled decisions. Do not look for `CANON.md` — it was rejected; Decision Log is the source of truth.
